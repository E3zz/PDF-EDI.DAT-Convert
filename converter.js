...
$('cvt').addEventListener('click',async()=>{
  ...
  try{
    ...
    showAlert('ok',`✓ EDI 835 built locally — ${segs.length} segments · ${claims.length} claim(s) · Total $${totalPaid} · Structure valid: ${valid?'YES ✓':'review output'} · No API used`);
  ...
  $('cvt').innerHTML='GENERATE EDI 835 — NO API NEEDED';
});
